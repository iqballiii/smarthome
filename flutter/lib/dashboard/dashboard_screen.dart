...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  Widget lightSwitches(int index) {
    return Consumer<FirebaseProviderClass>(
  ...
  Future<void> keepUpdating(FirebaseProviderClass data) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: Consumer<FirebaseProviderClass>(
      ...
      appBar: AppBar(
        ...
        toolbarHeight: 120.0,
        actions: [
          Consumer<FirebaseProviderClass>(
